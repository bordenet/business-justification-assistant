...
|---------|---------|--------|
| A. Full Investment Ghost Option | ⚠️ PARTIAL | Added `fullInvestment` pattern |
| B. ROI Formula Trap | ⚠️ PARTIAL | Expanded regex for variable names |
| C. Stakeholder/Equity | ❌ FALSE POSITIVE | Already in regex at line 70 |

 ...
 * Handles importing existing Business Justifications from Word/Google Docs via paste
 */
...
export function showImportModal() {
  ...
  saveBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      const title = titleMatch ? titleMatch[1].replace(/^Business Justification:\s*/i, '').trim() : `Imported ${DOC_TYPE_SHORT}`;

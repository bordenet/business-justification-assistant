/**
 * Tests for Business Justification Validator - Integration tests for assistant
 *
...
describe('Business Justification Validator Integration', () => {
  describe('validateDocument', () => {
    test('should return totalScore for valid content', () => {
      const result = validateDocument(`# Executive Summary
Request $30K to automate data entry.

# Problem Statement
Manual data entry wastes 500 hours per month.

# Solution
Automate the process to reduce effort by 80%.`);
